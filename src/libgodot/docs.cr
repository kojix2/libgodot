...
module Docs
  ...
  #       <td style="padding: 10px 14px;"><code>.\setup-dev.ps1 -Version &lt;ver&gt;</code></td>
  ...
  #       <td style="padding: 10px 14px;"><code>.\scripts\run_tests.ps1</code></td>
  ...
  module N_GODOT_UPGRADE_GUIDE
    def self.features : Array(String)
      [
        "Automated setup script via setup-dev.ps1",
